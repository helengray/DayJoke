 ...
 *
 */
public class JokeTextFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,EmptyEmbeddedContainer.EmptyInterface{
    ...
    private void initView(View view){
        ...
        mAdapter = new JokeTextAdapter(mJokeEnList);
